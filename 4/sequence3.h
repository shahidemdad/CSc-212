// PROVIDED BY: Catherine Matta (your name and email address)
// cmatta000@citymail.cuny.edu
// FILE: sequence3.h
...
namespace main_savitch_5
{
    ...
    public:
        ...
        size_t size( ) const{return node_count;} //Big O: O(1)
        bool is_item( ) const{return cursor !=NULL;} //Big O: O(1)
        value_type current( ) const{return cursor->data();} // Big O: O(1)
    private:
